          ...
          <Row>
            <Col md={7} className="home-header">
              ...
              <h1 className="heading-name">
                I'M
                <strong className="main-name"> DHARAN D</strong>
              </h1>
        ...
        <Row style={{ paddingTop: "50px", paddingBottom: "80px" }}>
          <Col md={12} className="home-about-social">
            ...
            <div style={{ marginTop: "20px" }}>
              <p>
                <strong>Email:</strong> dharandharan576@gmail.com<br />
                <strong>Phone:</strong> +91 87787 58710<br />
                <strong>Location:</strong> Dharmapuri, India
              </p>
            </div>
          </Col>
        </Row>
